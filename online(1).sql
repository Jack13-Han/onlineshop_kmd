...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2023 at 01:01 AM
...
(1, 7, 'kyawt', '09427798022', '581,Yangon', '2018-06-23', 1, '2023-01-07'),
(2, 7, 'kyawt', '09427798022', '581,Yangon', '2018-06-23', 1, '2023-01-07'),
...
(27, 7, 'kyawt', '09427798022', '581,Yangon', '2018-07-05', 1, '2023-01-07'),
(28, 7, 'kyawt', '09427798022', '581,Yangon', '2018-07-05', 0, '0000-00-00'),
(29, 13, 'oooo', '67878', 'yy', '2023-01-05', 1, '2023-01-07'),
(30, 13, 'oooo', '67878', 'yy', '2023-01-05', 1, '2023-01-07'),
(31, 18, 'htet', '9090', 'ygn', '2023-01-08', 0, '0000-00-00'),
(32, 17, 'qqqq', '45', 'ff', '2023-01-08', 0, '0000-00-00');
...
(14, 'lenovo', 1, 300000, 30, 'Photo.jpg'),
(15, 'sony', 3, 350000, 20, 'Flower3.png'),
(16, 'noodle', 5, 2000, 50, 'Photo2.jpg'),
(17, 'honda', 4, 10000000, 2, 'Photo3.jpg');
...
(10, 'kmd', '3314401782535bbfaded2826128ee985', 'kk@gmail.com', '45646', 'ff', 'user'),
(11, 'kmd1', '5c9e5058e9f9001e4728a64c0e3bcef4', 'kk@gmail.com', '45646', 'dfsdf', 'user'),
(12, 'dddd', '11ddbaf3386aea1f2974eee984542152', 'dd@gmail.com', '65756', 'sdfs', 'user'),
(13, 'oooo', 'ce7ce9108ae218e4ee612b0b36e3ed1d', 'oo@gmai.com', '67878', 'yy', 'user'),
(15, 'kmd2', '63cdaec302e6d812a55897da9a0f48b4', 'dd@gmail.com', '4545', 'yyyyy', 'user'),
(16, 'pppp', '2d7acadf10224ffdabeab505970a8934', 'pp@gmail.com', '65', 'gg', 'user'),
(17, 'qqqq', '3bad6af0fa4b8b330d162e19938ee981', 'qq@gmai.com', '45', 'ff', 'user'),
(18, 'htet', '2246fde955160d86deca9309fbaa0a8c', 'htet@gmail.com', '9090', 'ygn', 'user');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fkcuid` FOREIGN KEY (`customer_id`) REFERENCES `user` (`userid`),
  ADD CONSTRAINT `fkcustid` FOREIGN KEY (`customer_id`) REFERENCES `user` (`userid`);
